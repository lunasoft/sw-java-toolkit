...
public class SignTest {
    ...
    @Test
    public void certificateBase64Get() throws CertificateException, IOException {
    ...
    @Test
    public void keyBase64get() throws IOException {
        String filePath = new File("").getAbsolutePath();
    ...
    @Test
    public void noCertificateGet() throws CertificateException, IOException {
        String filePath = new File("").getAbsolutePath();
    ...
    @Test
    public void validityStartGet() throws CertificateException, IOException, ParseException {
        String filePath = new File("").getAbsolutePath();
    ...
    @Test
    public void validityEndGet() throws CertificateException, IOException, ParseException {
        String filePath = new File("").getAbsolutePath();
    ...
    @Test
    public void bussinesNameGet() throws CertificateException, IOException {
        String filePath = new File("").getAbsolutePath();
    ...
    @Test
    public void rfcGet() throws CertificateException, IOException {
        String filePath = new File("").getAbsolutePath();
    ...
    @Test
    public void signGet() throws IOException{
